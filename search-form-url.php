...
include_once(ELEMENTOR_PATH . 'includes/managers/controls.php');
include_once(ELEMENTOR_PATH . 'core/kits/documents/tabs/global-colors.php');
include_once(ELEMENTOR_PATH . 'core/kits/documents/tabs/global-typography.php');
include_once(ELEMENTOR_PATH . 'includes/controls/groups/box-shadow.php');
include_once(ELEMENTOR_PATH . 'includes/controls/groups/typography.php');
include_once(ELEMENTOR_PATH . 'includes/managers/icons.php');
include_once(ELEMENTOR_PATH . 'includes/utils.php');
include_once(ELEMENTOR_PRO_PATH . 'plugin.php');
include_once(ELEMENTOR_PRO_PATH . 'modules/theme-elements/widgets/base.php');
*/
...
class Search_Form_URL extends Base {

	public function get_name() {
		return 'search-form-url';
	}

	public function get_title() {
		return esc_html__( 'Search Form Url', 'elementor-pro' );
	}
